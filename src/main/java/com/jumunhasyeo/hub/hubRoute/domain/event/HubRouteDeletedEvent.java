...
@Schema(description = "HubRouteDeletedEvent")
@AllArgsConstructor
@Getter
public class HubRouteDeletedEvent extends HubRouteDomainEvent{
    ...
    public static HubRouteDeletedEvent from(HubRoute route) {
        return new HubRouteDeletedEvent(
                route.getRouteId(),
